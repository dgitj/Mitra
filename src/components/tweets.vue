			...
			<mdb-col sm="4">
				<mdb-card wide>
					...
					<mdb-card-body class="text-center" cascade>
						<mdb-card-title><strong>Bet</strong></mdb-card-title>
			...
			<mdb-col sm="4">
				<mdb-card narrow>
					...
					<mdb-card-body cascade>
						<h5 class="pink-text pb-2 pt-1"><mdb-icon icon="utensils" /> Culinary</h5>
						<mdb-card-title><strong>Cheat day inspirations</strong></mdb-card-title>
			...
			<mdb-col sm="4">
				<mdb-card cascade>
					...
					<mdb-card-body class="text-center" cascade>
						...
						<mdb-btn tag="a" floating small class="btn-tw"><mdb-icon fab icon="twitter" /></mdb-btn>
						<mdb-btn tag="a" floating small class="btn-dribbble"><mdb-icon fab icon="dribbble" /></mdb-btn>
					</mdb-card-body>
				</mdb-card>
			</mdb-col>
		</mdb-row>
...
<script>
	import { mdbContainer, mdbRow, mdbCol, mdbCard, mdbCardImage, mdbCardBody, mdbCardTitle, mdbCardText, mdbBtn, mdbView, mdbMask, mdbIcon } from 'mdbvue';
	export default {
		name: 'CardProPage',
		components: {
			mdbContainer,
